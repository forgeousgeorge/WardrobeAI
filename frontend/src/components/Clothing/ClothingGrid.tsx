  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center px-6">
        ...
        <h3 className="text-lg font-semibold text-gray-700 mb-1">Your wardrobe is empty</h3>
        <p className="text-sm text-gray-500">Tap the camera button above to add your first clothing item.</p>
      </div>
    )
  }
